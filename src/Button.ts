const Button = (editor, options = {}) => {
    ...
    editor.BlockManager.add(“button”, {
      ...
      content: {
        type: “button”,
        content:
          `<button class=“btn btn-primary bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded”>Double click to change text</button>`,
      ...
      attributes: {
        class:
          “button-icon-selected hover:border-orange-600 hover:bg-[#483831] pt-8",
      },
    });
            ...
            .forEach((addButtonLabel) => {
              addButtonLabel.addEventListener(“click”, function () {
                ...
                button.set(
                  ...
                  <button type=“submit” class=“btn btn-primary btn-style bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded”>${newLabel}</button>`
                );
                modal.close();
              });
            });
